  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        dive deeper into programming and learn more. I enrolled in a coding
      ...
      <p>
        ...
        books, watching movies, and playing with my freinds. I also enjoy{" "}
        <span className="font-medium">learning new things</span>. I'm also
        learning how to play the begena.
      </p>
    </motion.section>
  );
}
